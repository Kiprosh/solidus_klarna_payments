...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "spree_core", "~> 3.2.0.rc1"
  spec.add_dependency "spree_api", "~> 3.2.0.rc1"
  spec.add_dependency "spree_frontend", "~> 3.2.0.rc1"
  spec.add_dependency "spree_backend", "~> 3.2.0.rc1"
