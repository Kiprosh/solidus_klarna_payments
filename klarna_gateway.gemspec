...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "spree_core", "~> 3.0.8"
  spec.add_dependency "spree_api", "~> 3.0.8"
  spec.add_dependency "spree_frontend", "~> 3.0.8"
  spec.add_dependency "spree_backend", "~> 3.0.8"
